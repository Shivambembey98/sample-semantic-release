const registerController = require('../../user/controller/authController');
...
describe('register', () => {
    ...
    test('should return ALREADY_EXIST if mobile number is already registered', async () => {
        ...
        expect(sendResponse).toHaveBeenCalledWith(
            ...
            res,
            constant.CODE.BAD_REQUEST, // Changed from ALREADY_EXIST to BAD_REQUEST to match implementation
            {},
            0
        );
    });
