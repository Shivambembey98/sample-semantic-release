...
const MESSAGE = {
   ...
   EMAIL_SEND: `Please check your email inbox. Password 
   reset instructions sent to the associated email address.`,
   ...
   SUBCATEGORY_INVALID: "Sub category can not be same as Category name",
   ...
   REQUIRED_FIELDS: "{{key}} are required",
